"""risk-engine — health and metrics scaffold (PLAN 0.6).

    uv run uvicorn sentinel_risk_engine.main:app --port <port>

/health is the liveness probe; /metrics is Prometheus text. Everything this
service actually does arrives in later phases — see services/risk-engine/README.md.
"""
